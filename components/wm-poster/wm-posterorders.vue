<template>
	<view style="background: #FFFFFF;">
		...
		<!-- #ifdef MP-WEIXIN -->
		<image v-else lazy-load :src="tempFilePath" mode="widthFix" class="is-response" @longpress="saveqrcode" style="position: relative;"></image>
		...
		<!-- #endif -->
		<!-- <image src="https://cg.xianmxkj.com/file/uploadPath/2022/11/28/37355df08f85f039138d3269deb1aeb0.png" @click.stop="saveqrcode" style="width: 50rpx;height: 50rpx;position: absolute;top: 20rpx;right: 20rpx;" mode=""></image> -->
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			async OnCanvas() {
				...
				//#ifdef APP-PLUS
				_this.ctx.setFontSize(uni.upx2px(34)); //设置标题字体大小
				_this.Title = _this.Title.substring(0, 40)
				//#endif
				...
				_this.ctx.drawImage(_QrCode.path, 150, _this.canvasH - 130, q[0], q[1]);
				//添加二维码 end
